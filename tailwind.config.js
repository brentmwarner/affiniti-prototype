  ...
  theme: {
    extend: {
      fontFamily: {
        ...
        "text-sm-leading-6-normal":
          "var(--text-sm-leading-6-normal-font-family)",
        ...
        "text-xs-leading-5-medium":
          "var(--text-xs-leading-5-medium-font-family)",
      ...
      boxShadow: { "shadows-shadow": "var(--shadows-shadow)" },
      colors: {
